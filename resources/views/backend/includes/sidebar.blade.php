<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Electron Inc.</div>
  </a>
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item ">
    <a class="nav-link" href="{{ route('addBrand') }}">
      <i class="fas fa-fw fa-book"></i>
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item ">
    <a class="nav-link" href="{{ route('manageBrand') }}">
      <i class="fas fa-fw fa-table"></i>
      <span>Manage Brand</span></a>
  </li>
  ...
  <li class="nav-item ">
    <a class="nav-link" href="{{ route('manageOrder') }}">
      <i class="fas fa-fw fa-book"></i>
