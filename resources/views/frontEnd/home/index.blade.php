                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of.png">Add to Cart</button>
                  </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="2" data-name="Sunflower Oil"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of1.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3" data-name="Kabuli Chana"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of2.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4" data-name="Soya Chunks"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of3.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="5" data-name="Lays"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of4.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="6" data-name="Kurkure"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of5.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="7" data-name="Popcorn"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of6.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="8" data-name="Nuts"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of7.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="9" data-name="Banana"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of8.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="10" data-name="Onion"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of9.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="11" data-name="Bitter Gourd"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of10.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="12" data-name="Apples"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of11.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="13" data-name="Honey"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of12.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="14" data-name="Chocos"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of13.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="15" data-name="Oats"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of14.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="mid-1">
                  ...
                  <div class="add">
                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="16" data-name="Bread"
                      ...
                      data-image="{{ asset('') }}/frontEnd/images/of15.png">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-md-3 pro-1">
        <div class="col-m">
          <a href="{{ route('singleProduct',['id'=>$newProduct->id]) }}"
            ...
            @foreach (json_decode($newProduct->product_image) as $image)
          ...
          <div class="mid-1">
            <div class="women">
              <h6><a href="{{ route('singleProduct',['id'=>$newProduct->id]) }}">{{ $newProduct->product_name }}</a>
              </h6>
            </div>
            <div class="mid-2">
              {{-- <p><label>Tk.{{ $newProduct->product_price+2 }}.00</label><em
                class="item_price">Tk.{{ $newProduct->product_price }}.00</em></p> --}}
              <del>Tk.{{ $newProduct->product_price+(($newProduct->product_price/100)*10) }}</del> Tk.{{ $newProduct->product_price }}.00
              <div class="block">
                <div class="starbox small ghosting"> </div>
              </div>
              <div class="clearfix"></div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="17" data-name="Moisturiser"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of16.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="18" data-name="Lady Finger"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of17.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="19" data-name="Satin Ribbon Red"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of18.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="20" data-name="Grapes"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of19.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="21" data-name="Clips"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of20.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="22" data-name="Conditioner"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of21.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="23" data-name="Cleaner"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of22.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
        ...
        <div class="col-md-7 span-1 ">
          ...
          <div class="add-to">
            <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="24" data-name="Gel"
              ...
              data-image="{{ asset('') }}/frontEnd/images/of23.png">Add to Cart</button>
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
